...
ROOT_URLCONF = 'ecommAPI.urls'

CORS_ORIGIN_ALLOW_ALL = True
CORS_ALLOW_CREDENTIALS = True
CORS_ORIGIN_WHITELIST = (
    'http://uiengine:4200', 'http://127.0.0.0:4200'
)
...
WSGI_APPLICATION = 'ecommAPI.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'ecomm-api-dock-ng_databases_1',
        'PORT': '5432'
    }
}
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'ecommAPI', 'static'),
)
